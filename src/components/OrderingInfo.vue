<template>
  <div id="ordering-info">
    ...
    <img id="qrcode-img" v-if="orderData.name !== 'None'"
      :src="'https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=https://proladon.github.io/WUO.io/%23/search/' + refKey.trim()"
      alt="">
    <hr>
